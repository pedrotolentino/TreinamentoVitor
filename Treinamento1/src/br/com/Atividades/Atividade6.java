...
/**
 * Pedro: (13/01) - Dê uma revisada na lógica, pois todas as datas válidas testadas foram dadas como inválidas.
 * */
...
//Abaixo if usado criando uma condi��o para cada m�s onde entra na condi��o dos meses que terminam no dia 31
//e os meses que terminam no dia 30 e o unico mes que termina no dia 28		
		if(dia<=31 && mes==1 && mes==3 && mes==5 && mes==7 && mes==8 && mes==10 && mes==12 && ano<=2019) {
			System.out.println("A data � valida: "+dia+"/"+mes+"/"+ano);
